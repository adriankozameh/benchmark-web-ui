...
const spanish: Record<string, string> = {
  ...
  'Refresh delivery status': 'Actualizar estado del correo', 'Email:': 'Correo:',
  'Accepted by email provider': 'Aceptado por el proveedor de correo',
  'Delivery failed': 'Falló el envío', 'Sending pending': 'Envío pendiente',
